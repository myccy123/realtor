...
def welcome_for_signup(userid):
    ...
    mail_user="service@webmainland.com"    #用户名
    mail_pass="123456abC"   #口令
    sender = 'service@webmainland.com'
    receivers = [userid,'service@webmainland.com','chenli@realtoraccess.com','dxc@realtoraccess.com','yujh@realtoraccess.com']  # 接收邮件，可设置为你的QQ邮箱或者其他邮箱
    #正文
    message = MIMEMultipart('related')
    message['From'] = Header("service@webmainland.com", 'utf-8')
    ...
    <div style="margin: 8px;">
        ...
        <div style="border-radius: 5px;border-top: 3px solid rgba(0, 205 ,0,0.7); box-shadow: 0px 0px 5px 0px rgba(153,153,153,0.4); max-width: 800px; margin: auto; padding: 20px;">
            ...
            <p>Realtoraccess - a subdivision of Webmainland Media, is a membership based global realtor association, dedicated to facilitating global realtor access to the Chinese market.</p>
            <p>We try to position realtors as local experts, helping you deliver community knowledge and connections to the local and overseas Chinese community.</p>
            <p>Please complete the information on your dashboard. We will promote your profile at <a href="http://www.realtoraccess.com/web/agentlist" style="text-decoration: none; color: #70b1e7!important;">www.realtoraccess.com</a>. The SEO optimized profile page with RealtorAccess will enhance your presence in the Chinese online community, and it is free. Hooray!</p>
            <br>
            ...
            <p>If you have any questions or need help with anything, don't hesitate to shoot us an email at <a href="mailto:service@webmainland.com" style="text-decoration: none; color: #70b1e7!important;">service@webmainland.com</a> </p>
            <br>
        </div>
    </div>
...
def cust_msg(userid,msg):
    ...
    body = '''
            ...
            <p>Dear   <b>%s</b></p>
            <br>
            <p>A lead just left a message on your feature property URL %s. Here is the message:</p>
            <p>Name: %s</p>
            <p>E-mail: %s</p>
            <p>TEL: %s</p>
            <p>Message: %s</p>
    ...
    ''' % (userid,msg.get('url'),msg.get('name'),msg.get('email'),msg.get('tel'),msg.get('msg'))
    try:
        msgAlternative.attach(MIMEText(body, 'html', 'utf-8'))
        smtpObj = smtplib.SMTP()
        smtpObj.connect(mail_host, 25)    # 25 为 SMTP 端口号
