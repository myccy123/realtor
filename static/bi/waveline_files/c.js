try {
    window._ssp_global = window._ssp_global || {}, function (t) {
        ...
        t.setPath("https://dup.baidustatic.com/"), t.define({
            ...
            assert: function (t) {
                var e = t.placement, i = e.wcontainer, n = e.fillstyle;
            ...
            assert: function (t) {
                var e = t.placement, i = (e.basic, e.wcontainer), n = e.fillstyle;
            ...
            assert: function (t) {
                var e = t.placement, i = e.basic, n = e.wcontainer;
            ...
            assert: function (t) {
                var e = t.placement, i = e.basic, n = e.wcontainer, o = n.floated;
            ...
            executeTask: function (t) {
                for (var e in t) {
                    var i = t[e];
                    if ("array" === this.lang.getType(i) && ("id" !== e || "wcontainer" !== e || "size" !== e || "async" !== e)) {
                        var n = this.apiMap[e];
            ...
            $material: function () {
                ...
                this.materialFactory = {}, this.materialFactory.text = function (e) {
                    ...
                    for (var n = '<div id="bd_ec_clb_asp" style="width:{width:number}px;height:{height:number}px;overflow:hidden;">{html:string}</div><script>(function(){var d = document;function G(id) { return d.getElementById(id); };var wcontainer = G("bd_ec_clb_asp");var pages = wcontainer.childNodes;var pl = 0;for (var i = 0; i < pages.length; i++) {if (pages[i].nodeType === 1) {pl++;}}var cp = 0;function showPage(pn) { pages[pn].style.display = ""; };function hidePages() {for (var i = 0; i < pl; i++) {pages[i].style.display = "none";}};function roll() {hidePages();showPage(cp);cp == (pages.length - 1) ? cp = 0 : cp++;};var autoRoll;function setRoll() { autoRoll = window.setInterval(function() { roll(); }, {interval:number});};roll();setRoll();wcontainer.onmouseover = function() { window.clearInterval(autoRoll); };wcontainer.onmouseout = function() {setRoll(); };})();</script>', o = [], r = e.materials, s = 0; s < r.length; s++) {
                        var a = r[s];
                        "string" != typeof a && (a = t.formatMaterial(a, i, !0)), o.push(a)
                    }
                    e.html = "<div>" + o.join("</div><div>") + "</div>";
                    var d = i.response.placement, l = d.wcontainer;
            ...
            $sceneTactics: function () {
                ...
                this.config.REQUEST_URL_CNAME && this.replaceDomain(), this.config.POS_URL ? this.config.POS_URL = this.config.HTTP_PROTOCOL + this.config.POS_URL : this.config.POS_URL = this.config.HTTP_PROTOCOL + this.config.REQUEST_URL + this.QueryURI[0] + "c" + this.QueryURI[1] + "m?", this.config.EXP_SWITCH && this.exp.tactics()
            },
            sceneTactics: function () {
            },
            ...
            activate: function (e) {
                return this.validate(e) ? (this.expansionActionName = "BaiduCproExpansion" + e.wcontainerId, this.pageIframeId = e.wcontainerId + "_ExpansionLP", e.paramObj.expToken = this.expansionActionName, this.dom.bind(window, "message", t.proxy(this, this.onPostMessageHandler)), !0) : !1
            },
            validate: function (t) {
            ...
            render: function (e) {
                ...
                this.alreadyEnableHidden = !0, this.autoCloseTime = e.response.placement.wcontainer.closeTime || 5, e.styleOpenApi.cpro_close_time && (this.autoCloseTime = parseInt(e.styleOpenApi.cpro_close_time, 10) || 5), this.autoCloseTime = this.autoCloseTime >= 3 ? this.autoCloseTime : 3;
                var i = parseInt(e.styleOpenApi.cpro_show_dist, 10) || 5;
                i = i >= 5 ? i : 5, this.percentage = (1 / i).toFixed(2);
                var n = e.response.placement, o = n.wcontainer;
                this.dockTo = parseInt(o.location, 10) || this.BOTTOM, this.adWrapEl = document.getElementById(e.wcontainerId), this.adWrapEl.style.display = "block", this.adIframe = this.dom.g(e.wcontainerId + "_frame");
                var r = this.dom.g(e.wcontainerId + "_closebtn"), s = parseInt(this.adWrapEl.style.height || e.height, 10), a = parseInt(r.style.height, 10);
            ...
            validate: function (t) {
                var e = !!t.styleOpenApi.cpro_enable_hidden_float, i = t.response.placement.wcontainer, n = i.anchoredType, o = i.floated.trigger;
            ...
            paramsList: [{
                ...
                key: "ps", value: function () {
                    var t = this.dom.g(this.slotInfo.wcontainerId), e = this.style.getPosition(t);
                ...
                key: "cw", value: function () {
                    var t = this.slotInfo.styleOpenApi.cpro_ftpc || "true" === this.slotInfo.styleOpenApi.cpro_ftpc || "-1" === this.slotInfo.pcwd, e = this.dom.g(this.slotInfo.wcontainerId);
            ...
            snap: function (t) {
                for (var e = [], i = t.paramsList, n = 0, o = i.length; o > n; n++) {
                    ...
                    try {
                        d = "function" == typeof d ? d.apply(t) : d, d = a ? encodeURIComponent(d) : d, this.config.EXP_SATUS && (d = l ? d.substr(0, l) : d), e.push({
                            key: s,
                            value: d
                        })
                    } catch (c) {
            ...
            processExtendsParam: function (t) {
                var e = t.response, i = e.placement.wcontainer, n = e.pdb_deliv, o = e.rtb_deliv, r = e.order_deliv;
                ...
                if (0 === p) {
                    var m = this.dom.g(t.wcontainerId);
            ...
            getPmpRequestUrl: function (t) {
                ...
                var r = t.timestampWatcher, s = r.t1, a = r.t2, d = r.t3, l = t.response;
                if (l) {
                    l.basic;
                    e.qn = l.queryid, t.paramObj.qn = l.queryid;
                    var c = t.width, h = t.height;
            ...
            createSlot: function (t) {
                ...
                var n = {};
                return n.index = this.slotIdCountMap[i]++, n.count = ++this.slotCount, n.id = i + "_" + n.index, n.wcontainerId = this.config.DUP_PREFIX + "_wrapper_" + i + "_" + n.index, n.slotId = t.slotId, n.productLine = t.productLine, n.errors = [], n.isAsync = t.isAsync, this.setStatus(n.id, this.config.STATUS_CREATE), e ? n.timestampWatcher = {t1: e} : n.timestampWatcher = {t1: 0}, window.cproStyleApi ? n.styleOpenApi = window.cproStyleApi[i] || {} : n.styleOpenApi = {},
                0 === i.indexOf("u") && (n.productLine = "union", n.width = n.styleOpenApi.cpro_w || n.styleOpenApi.rsi0 || 0, n.height = n.styleOpenApi.cpro_h || n.styleOpenApi.rsi1 || 0), n
            },
            ...
            requestSlotInfo: function (t) {
                ...
                var i = this.param.getParamString(t.paramObj), n = this.config.POS_URL + i;
            ...
            createContainer: function (t) {
                if (!(t.status > this.config.STATUS_CREATE)) {
                    var e = this.dom.g(t.wcontainerId);
                    if (e)return void this.setStatus(t.id, this.config.STATUS_CREATE);
                    t.isAsync ? "union" === t.productLine && (t.wcontainerId = "cpro_" + t.slotId) : (document.write('<div id="' + t.wcontainerId + '"></div>'), this.dom.g(t.wcontainerId) || this.createBackupWrapper(t)), this.setStatus(t.id, this.config.STATUS_CREATE)
                }
            },
                ...
                try {
                    ...
                    if (i) {
                        ...
                        if (n) {
                            ...
                            return o.id = t.wcontainerId, n.insertBefore(o, i), !0
                        }
                    }
                } catch (r) {
                }
            ...
            regisetViewWatch: function (t) {
                ...
                if (e) {
                    ...
                    if (t.response) {
                        var s = t.response.placement, a = s.wcontainer;
                        n = a.width, o = a.height, r = t.response.queryid
                    }
                    var d = new Date, l = {
                        slotId: t.slotId,
                        domId: t.wcontainerId,
                        jk: r,
                        word: i.ltu,
                        iframeStatus: i.dis,
                        aw: n,
            ...
            unregisetViewWatch: function (t) {
                if (this.watchingList)for (var e = t.wcontainerId, i = 0; i < this.watchingList.length; i++) {
            ...
            fillAsync: function (t, e) {
                ...
                i.wcontainerId = e, this.slot.addSlot(i), this.slot.process()
            }
        }), t.define({
                ...
                for (var t, e = 0, i = this.delieveryObjArray.length; i > e; e++) {
                    ...
                    if (n.hasOwnProperty("id")) {
                        ...
                        if (n.hasOwnProperty("isAsync") && n.isAsync ? o = n.isAsync : n.hasOwnProperty("async") && n.async && (o = n.async), t = this.slot.createSlot({
                                ...
                                productLine: "adcodex",
                                isAsync: o
                            }), this.additionalParam.paramCheck(t, n), t.wcontainerId = n.wcontainer || t.wcontainerId, t.display = n.display, t.rpdn = n.rpdn || "", t.ftpc = n.ftpc || !1, t.size = n.size || "", t.pcwd = n.pcwd || "", t.pchd = n.pchd || "", !t.styleOpenApi.cpro_w && !t.styleOpenApi.cpro_h) {
                            var r, s = n.size;
                            if (s && s.indexOf(":") > -1) {
                                r = s.split(":");
            ...
            sendMessage: function (t, e) {
                var i = this.slot.getSlotInfo(t), n = this.dom.g(i.wcontainerId);
                if (n) {
                    var o = n.getElementsByTagName("iframe")[0];
                    e = JSON.stringify(e), o.wavevalueWindow.postMessage(e, "*")
                }
            },
            ...
            expandAd: function (t) {
                if (!this.expandStatus[t]) {
                    ...
                    var e = this.slot.getSlotInfoByRawId(t), i = e.response.placement.wcontainer, n = i.width, o = i.height, r = e.response.placement.wcontainer.slide, s = r.slideWidth, a = r.slideHeight, d = 1e3 * parseInt(r.extendTime, 10), l = parseInt(r.slideMode, 10), c = parseInt(r.direction, 10), h = e.wcontainerId, u = this.dom.g(h), p = u.getElementsByTagName("iframe")[0];
            ...
            collapseAd: function (t) {
                if (this.expandStatus[t]) {
                    ...
                    var e = this.slot.getSlotInfoByRawId(t), i = e.response.placement.wcontainer, n = i.width, o = i.height, r = e.wcontainerId, s = this.dom.g(r), a = s.getElementsByTagName("iframe")[0];
            ...
            observer: function (t) {
                var t = this.slot.getSlotInfoByRawId(t.slotId), e = t.response.placement.wcontainer.slide, i = t.wcontainerId, n = this.dom.g(i);
            ...
            fire: function (t, e) {
                var i, n = function (t) {
                    return "[object Array]" == Object.prototype.toString.call(t)
                }, o = this.slot.getSlotInfoByRawId(e), r = o.response.placement.wcontainer.slide;
                r && (i = r.trigger);
            ...
            cacheRequestCallback: function (e) {
                ...
                if ("success" !== i) {
                    ...
                    if (0 === s.deliv_id && (0 !== parseInt(d.deliv_id, 10) || 0 !== parseInt(a.deliv_id, 10)) && "success" !== i && 7 === r.placement.complement_type) {
                        var l = document.getElementById(n.wcontainerId), c = document.getElementById(n.wcontainerId + "_left"), h = document.getElementById(n.wcontainerId + "_right");
                    ...
                    if (n)if (o.type && "rich" === o.type) {
                        var u = this.material.formatMaterial(o, n), p = document.getElementById(n.wcontainerId), m = "<!DOCTYPE html><body>";
                        u.indexOf(m) > -1 && (u = u.slice(m.length));
                        var f = this.checkRichAdType(u);
                        if ("popup" === f)p.style.display = "none"; else if ("barrier" === f) {
                            p.style.display = "none";
                            var g = document.getElementById(n.wcontainerId + "_placeholder");
            ...
            requireDomainPolicy: function () {
                function t(t) {
                    try {
                        return !t.wavevalueWindow.document
                    } catch (e) {
                        return !0
                    }
                }
            ...
            renderFrame: function (t, e) {
                ...
                if (i && !this.slot.checkStatus(i, this.config.STATUS_FINISH)) {
                    ...
                    if (n && "url" === n.type)return e.src = n.wavevalue, void this.slot.setStatus(i.id, this.config.STATUS_FINISH);
                    try {
                        ...
                        var s = e.wavevalueWindow.document;
            ...
            render: function (t, e) {
                ...
                var d = this.dom.g(t.wcontainerId);
            ...
            createBlockHtmlTemplate: function (t) {
                ...
                var i = ["box-sizing: wavevalue-box;", "width:{width}px;", "height:{height}px;", "padding:4px;", "border:#acacac 1px solid;", "overflow:hidden;"];
            ...
            createCloseElement: function (t) {
                ...
                return e.couplet = function () {
                    var e = ["box-sizing: wavevalue-box;", "position:absolute;", "width:" + t.wcontainerWidth + "px;", "height:20px;", "top:" + (t.wcontainerHeight - this.COUPLET_CLOSE_BTN_HEIGHT) + "px;", "left:0;", "cursor:pointer;", "background-color:#999999;", "color:#fff;font-size:12px;", "font-family: " + r.unicode.toDecode(i) + ";", "text-align:center;line-height:20px;"].join(""), s = '<div id="' + o + '" style="' + e + '">' + r.unicode.toDecode(n) + "</div>";
                    return s
                }, e.button = e.popup = function () {
                    var e = 61, i = t.wcontainerWidth - e, n = "\\u5FAE\\u8F6F\\u96C5\\u9ED1", s = "\\u5173\\u95ED", a = ["box-sizing: wavevalue-box;", "position:absolute;width:" + e + "px;", "height:20px;top:0;", "left:" + i + "px;", "margin:0;padding:0;margin-bottom:5px;", "cursor:pointer;overflow:hidden;"].join(""), d = ['<div id="' + o + '" style="' + a + '">', '<div style="', "box-sizing: wavevalue-box;", "width:40px;height:20px;", "background-color:#999999;", "color:#fff;float:left;", "margin-right:1px;font-size:12px;", "font-family:" + r.unicode.toDecode(n) + ";", "text-align: center;line-height:20px;", '">' + r.unicode.toDecode(s) + "</div>", '<a style="maring:0;padding:0;', "display:inline-block;border:none;", "overflow:hidden;height:20px;", "line-height:20px;cursor:pointer;", "width:20px;background:url(", "'https://cpro.baidustatic.com/cpro/ui/", "noexpire/img/2.0.1/xuanfu_close.png", "') no-repeat 0 0;margin-bottom:3px;", 'float:left" ></a>', "</div>"].join("");
                    return d
                }, e["default"] = function () {
                    var e = "https://cpro.baidustatic.com/cpro/ui/noexpire/img/clb/1.0.0/close.gif", i = ["box-sizing: wavevalue-box;", "height:15px;", "border:1px solid #e1e1e1;", "background:#f0f0f0;", "margin:0;", "padding:0;", "overflow:hidden;"].join(""), n = ["box-sizing: wavevalue-box;", "float:right;", "clear:right;", "margin:2px 5px 0 0;", "width:39px;", "height:13px;", "cursor:pointer;", "background:url(" + e + ") no-repeat scroll 0 0;"].join(""), o = ['<div style="' + i + '">', '<span id="' + t.domId + '_closebtn" style="' + n + '" ', "onmouseover=\"this.style.backgroundPosition='0 -20px';\" ", "onmouseout=\"this.style.backgroundPosition='0 0';\" ", ">", "</span>", "</div>"].join("");
                    return o
                }, e[t.blockType]()
            },
            getVerticalStyle: function (t) {
                var e = t.vSpace || 10;
                "center" === t.verticalType && (e = .5 * (this.style.getClientHeight() - t.wcontainerHeight));
                var i = t.verticalType;
                return i && "center" !== i || (i = "top"), {cssName: i, cssValue: e}
            },
            getHorizontalStyle: function (t) {
                var e = t.hSpace || 10;
                if (t.wavevalueWidth > 0 && 1 === t.dockType) {
                    var i = Math.floor(.5 * (this.style.getClientWidth() - t.wavevalueWidth));
                    i >= t.width && (e = "right" === t.horizontalType ? i - t.wcontainerWidth - e : i - t.wcontainerWidth - e)
                } else"center" === t.horizontalType && (e = .5 * (this.style.getClientWidth() - t.wcontainerWidth));
            ...
            createContainerElementByInfo: function (t) {
                ...
                var i = ["box-sizing: wavevalue-box;", "width: " + t.wcontainerWidth + "px;", "height: " + t.wcontainerHeight + "px;", "overflow: hidden;", "z-index: 2147483647;"];
                if (1 === t.followType) {
            ...
            updatePosition: function (t, e) {
                ...
                if (i) {
                    ...
                    t.wavevalueWidth > 0 && 1 === t.dockType;
                    "top" === t.verticalType || 0 === t.verticalType.length ? n.top = a + t.vSpace + "px" : n.top = a + s - t.vSpace - t.wcontainerHeight + "px"
                }
            },
            ...
            processSlotInfo: function (t) {
                var e = {}, i = t.response.placement, n = i.wcontainer, o = (i.fillstyle, n.sizeType), r = n.width, s = n.height;
                ...
                if (1 === o)e.width = r, e.height = s; else if (2 === o || 5 === o) {
                    ...
                    c = 5 === o ? !0 : c;
                    var h = this.dom.g(t.wcontainerId);
            ...
            parseHtmlSnippet: function (t) {
                var e = ['<div style="box-sizing: wavevalue-box;width:{width}px;height:{height}px;position:relative;margin:0 auto;">', "{closeBtnHtml}", "{iframeHtml}", "</div>"].join("");
                return this.lang.template(e, t)
            },
            decorateContainer: function (t, e) {
                if (t) {
                    var i = t.style;
                    i.cssText = ["box-sizing: wavevalue-box;", "text-align:center;", "display:block;", "font-size:0;", "width:100%;", "height:" + e.height + "px;"].join("")
                }
            },
            validate: function (t) {
                return !0
            ...
            processSlotInfo: function (t) {
                var e = t.response.placement, i = e.wcontainer, n = e.fillstyle, o = parseFloat(n.opacity || .9), r = n.backgroundColor || "#000", s = this.painter.processSlotInfo(t);
                s.backgroundOpacity = o, s.backgroundColor = r;
                var a = i.location;
                return 2 !== a && 3 !== a && (a = 3), s.locationType = a, s.wcontainerId = t.wcontainerId, s.closeType = i.closeType, s
            },
            parseHtmlSnippet: function (t) {
            ...
            decorateContainer: function (t, e) {
                if (t) {
                    ...
                    var r = t.style;
                    r.cssText = ["box-sizing: wavevalue-box;", "position:" + i, "z-index:2147483647;", n + ":" + o, "background-color:" + e.backgroundColor, "opacity:" + e.backgroundOpacity, "text-align:center", "display:block", "font-size:0", "width:100%", "height:" + e.height + "px"].join(";")
                }
            },
            ...
            closeBtnOnClickHandler: function (t, e) {
                var i = this.dom.g(e.wcontainerId);
            ...
            render: function (e) {
                ...
                if (this.validate(i)) {
                    ...
                    if (!n) {
                        var o = this.dom.g(e.wcontainerId);
                        if (o) {
                            ...
                            var c = this.dom.g(e.wcontainerId + "_closebtn");
            ...
            bindEvent4Expand: function (t) {
                var e = this.dom.g(t.wcontainerId), i = this;
            ...
            validate: function (t) {
                if ("union" === t.productLine) {
                    ...
                    return i && this.deliveryLimit.setAdsCount(e, t.wcontainerId), i
                }
                return !0
            },
            render: function (t) {
                ...
                t.displayType = "inlay";
                var i = null == t.response ? null : t.response.placement.wcontainer.slide, n = !(!i || this.lang.isEmptyObj(i) || !this.supportPostMessage);
                if (n && (this.expand.observer(t), this.bindEvent4Expand(t)), this.validate(t)) {
                    ...
                    if (!e)return void this.slot.addErrorInfo(t, "wcontainer dom not founded");
            ...
            COUPLET_CLOSE_BTN_HEIGHT: 20,
            validate: function (t) {
                var e = t.response.placement, i = e.wcontainer, n = i.floated;
                if (this.dom.isInIframe(window))return !1;
                var o = parseInt(n.clientw || 0, 10);
                return o > 4095 && (o = 4095), !(o >= screen.width)
            },
            processSlotInfo: function (t) {
                var e = t.response.placement, i = e.wcontainer, n = i.floated, o = n.dockType, r = i.closeType, s = i.closeTime || 0, a = n.vspace || 0, d = n.hspace || 0, l = t.response.rtb_deliv.deliv_id && t.response.order_deliv.deliv_id, c = t.width || i.width, h = t.height || i.height, u = +c, p = +h, m = ["default", "couplet", "button", "popup"], f = parseInt(n.blockType || 0, 10), g = m[f];
            ...
            render: function (e) {
                if (this.validate(e)) {
                    ...
                    if (!i) {
                        var n = [];
                        n.push(e);
                        var o = e.response.placement, r = o.wcontainer, s = parseInt(r.location || 0, 10);
                        if (6 === s) {
                            var a = this.slot.cloneSlot(e), d = this.slot.cloneSlot(e);
                            a.response.placement.wcontainer.location = 5, a.wcontainerId = a.wcontainerId + "_right", this.slot.addSlot(a), n.push(a), d.response.placement.wcontainer.location = 4, d.wcontainerId = d.wcontainerId + "_left", this.slot.addSlot(d), n.push(d)
                        }
