...
Vue.component('headmenu', {
    template: `
    <header>
	<div class="namebox" v-if="screesize">{{username}}</div>
        <div class="menu">
        <div class="show_box_header">
    		<img src="http://www.realtoraccess.com/static/web/agent4/src/img/wphone@3x.png"/>
    		<a :href="'tel:' + tel">{{tel}}</a>
    		<img src="http://www.realtoraccess.com/static/web/agent4/src/img/del.png"  @click="homehide($event)" class="showimg"/>
    	</div>
            <div class="container">
                <ul>
                ...
                <div class="show_box_bot">
    				...
    				<img :src="qrcode"/>
    				<span style="position: relative; top: -12px;">扫码添加微信</span>
    			</div>
            </div>
        </div>
    </header>`,
     props: ['tel','gourl','qrcode','username','screesize'],
     methods: {
...
Vue.component('asideCommon', {
    template: `<aside >
		<div class="asideCommon_top">
		<img style="display: block" class="inner-aside-bg" :src="myimg" alt="">
		</div>
        <div class="house-footer bdsharebuttonbox">
            <img class="footer-img-pc" src="http://www.realtoraccess.com/static/web/agent4/src/img/home-aside-bg.png" v-if="screesize">
            <img class="footer-img-m" src="http://www.realtoraccess.com/static/web/agent4/src/img/footer-m.jpg" v-if="!screesize">
				...
				<ul class="share">
				    <a
				        href="javascript:window.open('http://www.facebook.com/sharer.php?u='+encodeURIComponent(document.location.href)+'&t='+encodeURIComponent(document.title),'_blank','toolbar=yes, location=yes, directories=no, status=no, menubar=yes, scrollbars=yes, resizable=no, copyhistory=yes, width=600, height=450,top=100,left=350');void(0)"><img
				            src="http://www.realtoraccess.com/static/sp/smf1/src/img/fs.png" /></a>
				    <a href="#"><img data-cmd="tsina" src="http://www.realtoraccess.com/static/sp/smf1/src/img/wb.png" /></a>
				    <a href="#"><img data-cmd="weixin" src="http://www.realtoraccess.com/static/sp/smf1/src/img/wx.png" /></a>
				</ul>
        </div>
    
    </aside>`,
    props: ['myname','myimg','note','website','logo','screesize']
})
// 左侧logo
